...
const Hero: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-[#060910] pt-16 pb-8 sm:pb-16 min-h-[80vh] flex flex-col justify-center items-center">
      {/* Decorative Stones - big, glowing, accurate positions, hidden on small screens */}
      {/* <DecorativeStone
        src="/landing/hero_ring.svg"
        alt="Decorative Stone Bottom Left"
        className="left-[-80px] bottom-[-80px] lg:left-[-120px] lg:bottom-[-120px]"
        size={260}
        glowColor="#f7c873"
      />
      <DecorativeStone
        src="/landing/hero_stone.svg"
        alt="Decorative Stone Top Right"
        className="right-[-60px] top-[-60px] lg:right-[-100px] lg:top-[-100px]"
        size={220}
        glowColor="#f7c873"
      /> */}
      ...
      <div className="relative z-10 flex justify-center w-full mt-2">
        <Image
          ...
          width={900}
          height={440}
          className="rounded-xl shadow-2xl w-full max-w-4xl h-auto border border-[#23272F] bg-[#10131c]"
          priority
        />
      </div>
    </section>
