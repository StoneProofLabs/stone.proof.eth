...
const FullPageLoader = ({ text = "Verifying buyer permissions..." }: { text?: string }) => (
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-gray-800 rounded-xl shadow-lg border border-gray-700">
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-300">Your wallet doesn't have buyer access permissions to view this dashboard.</p>
