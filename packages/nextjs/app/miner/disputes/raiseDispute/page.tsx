...
import { Copy, Loader2, ShieldAlert, ChevronDown, AlertCircle, Minus, Check } from "lucide-react";
...
export default function RaiseDisputePage() {
  ...
  const onSubmit = async (data: DisputeFormData) => {
    ...
    try {
      ...
      // No need to convert mineralId to BigInt since contract expects string
  ...
  const pendingMinerals = [
    ...
    {
      id: "LITHIUM-0xb4c7f9a3",
      name: "Lithium",
      date: "15/05/2025",
      purity: 95,
      quantity: "300 KG",
      price: "$9,000",
      image: "/dashboard/lithium.png",
    },
  ];
