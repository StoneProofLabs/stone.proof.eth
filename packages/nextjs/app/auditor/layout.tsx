  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-gray-800 rounded-xl shadow-lg border border-gray-700">
      <div className="text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold text-white">Auditor Privileges Required</h2>
        <p className="text-gray-300">Your wallet doesn't have auditor access permissions to view this dashboard.</p>
