...
const InspectorRegisterPage = () => {
  ...
  const [form, setForm] = useState({
    ...
    email: "",
    phone: "",
    inspectorId: "0xinspector-1234-5678-90ab",
    password: "",
    specialization: "",
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(form.inspectorId);
    setCopySuccess(true);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center py-8 px-2">
      <h1 className="text-2xl md:text-4xl font-bold text-white mb-8 text-center">Register New Inspector</h1>
      <div className="border-[#323539] p-3">
        ...
        >
          <div className="flex flex-col md:flex-row gap-8 w-full">
            ...
            <div className="flex-1 flex flex-col gap-4 min-w-0">
              <div>
                <label className="text-xs text-white">INSPECTOR_ID</label>
                <div className="flex items-center gap-2 mt-1">
                  <div className="flex items-center bg-[#23262F] border border-[#323539] rounded-lg px-3 py-2 w-full">
                    <FaLock className="text-gray-400 mr-2" />
                    <span className="text-white font-mono text-base flex-1 truncate">{form.inspectorId}</span>
                    <button
                      type="button"
                ...
                <span className="text-xs text-gray-400">Valid until sign in of the inspector</span>
              </div>
              <div>
              ...
              <div>
                <label className="text-xs text-white">Inspector Legal Document</label>
          ...
          <p className="text-lg text-gray-400 mt-2 text-center md:text-left">
            The Inspector will receive the email containing the above info for login
          </p>
        </form>
      </div>
    </div>
