...
export declare namespace TransactionLog {
...
export interface TransactionLog extends BaseContract {
  ...
  getOperationsCount: TypedContractMethod<[], [bigint], "view">;
  ...
  filters: {
    ...
    "OperationRecorded(address,string,string,uint256)": TypedContractEvent<
      OperationRecordedEvent.InputTuple,
      OperationRecordedEvent.OutputTuple,
      OperationRecordedEvent.OutputObject
    >;
    OperationRecorded: TypedContractEvent<
      OperationRecordedEvent.InputTuple,
      OperationRecordedEvent.OutputTuple,
      OperationRecordedEvent.OutputObject
    >;
    ...
    "TransactionRecorded(uint256,address,address,string,uint256,string)": TypedContractEvent<
      TransactionRecordedEvent.InputTuple,
      TransactionRecordedEvent.OutputTuple,
      TransactionRecordedEvent.OutputObject
    >;
