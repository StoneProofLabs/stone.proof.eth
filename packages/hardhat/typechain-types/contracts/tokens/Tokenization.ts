...
export interface TokenizationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AUDITOR_ROLE"
      | "BUYER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "getTokenIdByMineralId",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "mineralToToken",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, string, boolean, boolean, boolean]
  ): string;
...
export namespace MintedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, mineralId: string, to: string];
  export interface OutputObject {
    tokenId: bigint;
    mineralId: string;
    to: string;
...
export interface Tokenization extends BaseContract {
  connect(runner?: ContractRunner | null): Tokenization;
  ...
  getTokenDetails: TypedContractMethod<
    [tokenId: BigNumberish],
    [
      [bigint, string, string, boolean, boolean, boolean, boolean, string] & {
        id: bigint;
        mineralId: string;
        details: string;
        isMinted: boolean;
  ...
  getTokenIdByMineralId: TypedContractMethod<
    [mineralId: string],
    [bigint],
    "view"
  >;
  ...
  mineralToToken: TypedContractMethod<[arg0: string], [bigint], "view">;

  mintToken: TypedContractMethod<
    [to: AddressLike, mineralId: string, details: string],
    [void],
    "nonpayable"
  >;
  ...
  updateMetadata: TypedContractMethod<
    [tokenId: BigNumberish, newDetails: string],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getTokenIdByMineralId"
  ): TypedContractMethod<[mineralId: string], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "mineralToToken"
  ...
  filters: {
    ...
    "Minted(uint256,string,address)": TypedContractEvent<
      MintedEvent.InputTuple,
      MintedEvent.OutputTuple,
      MintedEvent.OutputObject
    >;
    ...
    "Updated(uint256)": TypedContractEvent<
      UpdatedEvent.InputTuple,
      UpdatedEvent.OutputTuple,
      UpdatedEvent.OutputObject
    >;
