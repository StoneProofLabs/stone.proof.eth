...
export interface MineralWarehouseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AUDITOR_ROLE"
      | "BUYER_ROLE"
      ...
      | "hasTransporterRole"
      | "inspectMineral"
      | "isMineralMarketReady"
      | "isMineralRegistered"
      | "list_Mineral_ForSale"
      | "mineralDetails"
      | "mineralHistories"
      | "purchaseMineral"
      | "purchase_mineral"
      ...
      | "revokeTransporter"
      | "roleMemberCount"
      | "store_refined_mineral_to_warehouse"
      | "supportsInterface"
      | "transferMineral"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMineralPriceInToken",
  ...
  encodeFunctionData(
    functionFragment: "isMineralMarketReady",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "list_Mineral_ForSale",
    values: [string, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "purchase_mineral",
  ...
  encodeFunctionData(
    functionFragment: "store_refined_mineral_to_warehouse",
    values: [string, BigNumberish, AddressLike[], BigNumberish[]]
  ): string;
  encodeFunctionData(
...
export namespace MineralListedForSaleEvent {
  export type InputTuple = [
    mineralId: string,
    price: string,
    lister: AddressLike
  ];
  export type OutputTuple = [mineralId: string, price: string, lister: string];
  export interface OutputObject {
    mineralId: string;
    price: string;
    lister: string;
...
export namespace MineralSoldEvent {
  export type InputTuple = [
    mineralId: string,
    buyer: AddressLike,
    seller: AddressLike,
...
export namespace MineralStoredEvent {
  export type InputTuple = [
    mineralId: string,
    refiner: AddressLike,
...
export interface MineralWarehouse extends BaseContract {
  connect(runner?: ContractRunner | null): MineralWarehouse;
  waitForDeployment(): Promise<this>;

  interface: MineralWarehouseInterface;
  ...
  getMineralPriceInToken: TypedContractMethod<
    [_mineralId: string, token: AddressLike],
    [bigint],
    "view"
  >;
  ...
  isMineralMarketReady: TypedContractMethod<
    [_mineralId: string],
    [boolean],
    "view"
  >;
  ...
  list_Mineral_ForSale: TypedContractMethod<
    [_mineralId: string, _price: string],
    [void],
    "nonpayable"
  >;
  ...
  purchase_mineral: TypedContractMethod<
    [
      _mineralId: string,
      method: BigNumberish,
      token: AddressLike,
  ...
  store_refined_mineral_to_warehouse: TypedContractMethod<
    [
      _mineralId: string,
  ...
  >;
  getFunction(
    nameOrSignature: "getMineralPriceInToken"
  ): TypedContractMethod<
    [_mineralId: string, token: AddressLike],
    [bigint],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "isMineralMarketReady"
  ): TypedContractMethod<[_mineralId: string], [boolean], "view">;
  getFunction(
    nameOrSignature: "isMineralRegistered"
  ): TypedContractMethod<[mineralId: string], [boolean], "nonpayable">;
  getFunction(
    nameOrSignature: "list_Mineral_ForSale"
  ): TypedContractMethod<
    [_mineralId: string, _price: string],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "purchase_mineral"
  ): TypedContractMethod<
    [
      _mineralId: string,
      method: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "store_refined_mineral_to_warehouse"
  ): TypedContractMethod<
    [
      _mineralId: string,
      _priceETH: BigNumberish,
  ...
  >;
  getEvent(
    key: "MineralListedForSale"
  ): TypedContractEvent<
    MineralListedForSaleEvent.InputTuple,
    MineralListedForSaleEvent.OutputTuple,
    MineralListedForSaleEvent.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    MineralSoldEvent.InputTuple,
    MineralSoldEvent.OutputTuple,
    MineralSoldEvent.OutputObject
  >;
  getEvent(
    key: "MineralStored"
  ): TypedContractEvent<
    MineralStoredEvent.InputTuple,
    MineralStoredEvent.OutputTuple,
    MineralStoredEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "MineralListedForSale(string,string,address)": TypedContractEvent<
      MineralListedForSaleEvent.InputTuple,
      MineralListedForSaleEvent.OutputTuple,
      MineralListedForSaleEvent.OutputObject
    >;
    MineralListedForSale: TypedContractEvent<
      MineralListedForSaleEvent.InputTuple,
      MineralListedForSaleEvent.OutputTuple,
      MineralListedForSaleEvent.OutputObject
    >;
    ...
    "MineralSold(string,address,address,uint256)": TypedContractEvent<
      MineralSoldEvent.InputTuple,
      MineralSoldEvent.OutputTuple,
      MineralSoldEvent.OutputObject
    >;
    MineralSold: TypedContractEvent<
      MineralSoldEvent.InputTuple,
      MineralSoldEvent.OutputTuple,
      MineralSoldEvent.OutputObject
    >;

    "MineralStored(string,address,uint256)": TypedContractEvent<
      MineralStoredEvent.InputTuple,
      MineralStoredEvent.OutputTuple,
      MineralStoredEvent.OutputObject
    >;
    MineralStored: TypedContractEvent<
      MineralStoredEvent.InputTuple,
      MineralStoredEvent.OutputTuple,
      MineralStoredEvent.OutputObject
    >;
