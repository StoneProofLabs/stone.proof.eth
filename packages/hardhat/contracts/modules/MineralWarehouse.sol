...
contract MineralWarehouse is RolesManager, MineralRegistry {
    ...
    constructor(address rolesManagerAddress, address mineralRegistryAddress) 
    ...
    function list_Mineral_ForSale(string memory _mineralId, string memory _price) 
        public restrictedToRole(REFINER_ROLE) {
        StoredMineral storage mineral = warehouse[_mineralId];
    ...
    function getMineralPriceInToken(string memory _mineralId, address token) 
